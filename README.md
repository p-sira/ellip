...
Benchmark on AMD Ryzen 5 4600H with Radeon Graphics @3 GHz running x86_64-unknown-linux-gnu rustc 1.90.0 using ellip v0.5.6 at `f64` precision (ε=2.2204460492503131e-16).
