...
This report is generated on AMD EPYC 7763 64-Core Processor running x86_64-unknown-linux-gnu rustc 1.92.0 using ellip v1.0.0 at `f64` precision (ε=2.2204460492503131e-16).
...
Generated on AMD EPYC 7763 64-Core Processor running x86_64-unknown-linux-gnu rustc 1.92.0 using ellip v1.0.0 at `f32` precision (ε≈1.19e-7).
