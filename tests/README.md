...
This report is generated on AMD EPYC 7763 64-Core Processor running `x86_64-unknown-linux-gnu rustc 1.93.1` using ellip v1.1.0 with `libm` at `f64` precision (ε≈2.22e-16).
...
Generated on AMD EPYC 7763 64-Core Processor running `x86_64-unknown-linux-gnu rustc 1.93.1` using ellip v1.1.0 with `libm` at `f32` precision (ε≈1.19e-7).
