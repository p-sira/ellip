...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    plot.set_layout(
        Layout::new()
            ...
            .text(format!(
                "Generated using <a href=\"https://docs.rs/ellip/latest/ellip/carlson/fn.elliprd.html\" target=\"_blank\">elliprd</a> from <a href=\"https://crates.io/crates/ellip\" target=\"_blank\">ellip</a> v{}",
                ellip_version()
            ))
                .x_ref("paper")
                .y_ref("paper")
    ...
    make_html!(plot, "elliprd.html");
    write_svg!(plot, "elliprd.svg", 1000, 600, 1.0);
    Ok(())
}
