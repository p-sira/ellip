...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    plot.set_layout(
        Layout::new()
            ...
            .text(format!(
                "Generated using the function <a href=\"https://docs.rs/ellip/latest/ellip/fn.jacobi_zeta.html\" target=\"_blank\">jacobi_zeta</a> from <a href=\"https://crates.io/crates/ellip\" target=\"_blank\">ellip</a> v{}",
                ellip_version()
            ))
                .x_ref("paper")
                .y_ref("paper")
