...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    plot.set_layout(
        Layout::new()
            ...
            .text(format!(
                "Generated using <a href=\"https://docs.rs/ellip/latest/ellip/bulirsch/fn.cel2.html\" target=\"_blank\">cel2</a> from <a href=\"https://crates.io/crates/ellip\" target=\"_blank\">ellip</a> v{}",
                ellip_version()
            ))
                .x_ref("paper")
                .y_ref("paper")
    ...
    write_svg!(plot, "cel2_plot.html", 900, 600, 1.0);
    println!("Done");
    Ok(())
}
