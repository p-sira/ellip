...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    plot.set_layout(
        Layout::new()
            ...
            .text(format!(
                "Generated using <a href=\"https://docs.rs/ellip/latest/ellip/carlson/fn.elliprf.html\" target=\"_blank\">elliprf</a> from <a href=\"https://crates.io/crates/ellip\" target=\"_blank\">ellip</a> v{}",
                ellip_version()
            ))
                .x_ref("paper")
                .y_ref("paper")
    ...
    make_html!(plot, "elliprf_plot.html");
    write_svg!(plot, "elliprf_plot.svg", 1000, 600, 1.0);
    println!("Done");
    Ok(())
}
